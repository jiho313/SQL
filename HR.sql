...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "LOCATIONS_SEQ"  MINVALUE 1 MAXVALUE 9900 INCREMENT BY 100 START WITH 3400 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
...
REM INSERTING into SALARY_GRADES
SET DEFINE OFF;
Insert into SALARY_GRADES (GRADE,MIN_SALARY,MAX_SALARY) values ('A',50000,99999);
Insert into SALARY_GRADES (GRADE,MIN_SALARY,MAX_SALARY) values ('B',20000,49999);
Insert into SALARY_GRADES (GRADE,MIN_SALARY,MAX_SALARY) values ('C',10000,19999);
Insert into SALARY_GRADES (GRADE,MIN_SALARY,MAX_SALARY) values ('D',5000,9999);
Insert into SALARY_GRADES (GRADE,MIN_SALARY,MAX_SALARY) values ('E',2500,4999);
Insert into SALARY_GRADES (GRADE,MIN_SALARY,MAX_SALARY) values ('F',1000,2499);
Insert into SALARY_GRADES (GRADE,MIN_SALARY,MAX_SALARY) values ('G',0,999);
